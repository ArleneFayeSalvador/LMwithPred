...
summary.lm(model.1,interval="prediction")
```
This is a linear model of SIMS based on ARM strength. The adjusted R-square is equal to 0.467.
...
# model3
Sims is a function of ARM and GRIP strength
...
``` 
The adjusted R-Square for model 3 is 0.5358, so it is a bigger model based on ARM.
